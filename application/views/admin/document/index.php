                    ...
                    <form action="" id="form-table" method="post">
                        ...
                        <table id="data-table" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th><?php echo lang('text_order'); ?></th>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_info">
                            ...
                            $list = [
                                ...
                                ['name' => 'price', 'title' => 'Giá', 'class' => '', 'type' => 'price', 'required' => false],
...
<!-- End Bootstrap modal -->
<script>
    var url_ajax_load_category = '<?= site_url('admin/category/ajax_load/document') ?>';
    var url_ajax_load = '<?= site_url('admin/category/ajax_load/document') ?>';
</script>
