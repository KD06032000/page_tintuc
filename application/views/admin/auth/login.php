...
<body class="hold-transition login-page" style="background: url('<?php echo base_url() ?>public/admin/img/bg_ssc.jpg') center center no-repeat; background-size: cover;overflow: hidden;">
<div class="login-box">
    <div class="login-logo">
        <img src="<?php echo base_url() ?>public/admin/img/logo.svg" width="300">
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <div class="row">
            <!-- /.col -->
            <div class="col-xs-12">
                <button type="submit" style="background-color: #605ca8" class="btn btn-primary btn-block btn-flat"><?php echo lang('login_submit_btn') ?></button>
            </div>
            <!-- /.col -->
        </div>
        <?php echo form_close() ?>
