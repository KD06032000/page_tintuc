    ...
    <ul class="nav nav-tabs">
      <?php foreach ($this->config->item('cms_language') as $lang_code => $lang_name) { ?>
        <li<?php echo ($lang_code == 'vi') ? ' class="active"' : ''; ?>>
          <a href="#tab_why_us_<?php echo $lang_code . $id; ?>" data-toggle="tab">
            <?php echo $lang_name; ?>
          </a>
        </li>
      <?php } ?>
    ...
    <div class="col-md-10 tab-content">
        <?php foreach ($this->config->item('cms_language') as $lang_code => $lang_name) { ?>
          <div class="tab-pane <?php echo ($lang_code == 'vi') ? 'active' : ''; ?>"
              id="tab_why_us_<?php echo $lang_code . $id; ?>">
            <fieldset class="">
                <div class="row">
                  <div class="col-md-12">
    ...
    <div class="col-md-2">
      <input
          ...
          <img onclick="chooseImage('<?php echo $meta_key . '_' . $id; ?>')"
            ...
            alt="" height="150px" style="height: 150px; width: 150px; object-fit: cover; margin-top: 6px; cursor: pointer;">
    </div>
  </div>
